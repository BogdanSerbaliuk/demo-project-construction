...
function Location() {
    ...
    return(
        <section className="w-full min-h-screen flex flex-col items-center justify-between  bg-gray-800 text-white py-12 px-4">
            <div className="w-full max-w-6xl flex flex-col items-start justify-center gap-6">
            ...
            <div className="w-full max-w-4xl aspect-square md:aspect-video overflow-hidden pt-12 ">
                <iframe
