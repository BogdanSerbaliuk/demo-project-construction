            ...
            <div className="flex w-full max-w-6xl flex-col items-center gap-8">
                ...
                <ul className="flex w-full flex-wrap justify-center gap-6">
                    {visibleItems.map((manager) => (
                        ...
                        >
                            <article className="flex h-full flex-col items-center gap-4 rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-orange-950 p-5 text-center @sm:flex-row @sm:gap-5 @sm:text-left transition-transform hover:scale-105">
                                <img
                                    src={manager.image}
                                    alt={manager.name}
                                    loading="lazy"
